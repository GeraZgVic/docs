...
<Note>
  ...
  Para el historial completo de cambios ver [Checkpoint Técnico](/kueski-pay-checkpoint).
</Note>
...
| `KueskiApi.php` | Modificar — agregar `refund()` — ✅ Completado — [v1.13](/kueski-pay-checkpoint) |
| `func.php` | Modificar — hook + install/uninstall — ✅ Completado — [v1.13](/kueski-pay-checkpoint) |
| `init.php` | Modificar — registrar hook — ✅ Completado — [v1.13](/kueski-pay-checkpoint) |
